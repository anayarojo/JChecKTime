 ...
 * @author Raul
 */
public class JfrmMenuEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form JfrmMenuEmpleado
     */
    public JfrmMenuEmpleado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmMenuEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmMenuEmpleado().setVisible(true);
            }
        });
    }
