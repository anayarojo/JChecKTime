...
public final class JfrmMODEmpleado extends javax.swing.JFrame {
    ...
    pnlMODEmpleadoPagina1 Pagina1;
    pnlMODEmpleadoPagina2 Pagina2;
    
    JfrmCATEmpleado CatalogoEmpleado;
    
    public JfrmMODEmpleado(JfrmCATEmpleado Catalogo, int id /*idEmpleado*/) {
        initComponents();
        
        idEmpleado=id;
        CatalogoEmpleado=Catalogo;
        
        this.setLocationRelativeTo(null); //Ventana centrada
        this.setTitle("Registrar Empleado");
        this.setIconImage(new ImageIcon(getClass().getResource("/Imagenes/Iconos/ModificarEmpleado.png")).getImage());
    ...
    public void MostrarPagina1(){
        ...
        Pagina1=new pnlMODEmpleadoPagina1(pnlPrincipal.getSize());
    ...
    public void MostrarPagina2(){
        ...
        pnlPrincipal.removeAll();
        Pagina2=new pnlMODEmpleadoPagina2(pnlPrincipal.getSize());
    ...
    private RESULTADO.enumResultados ValidarDatos(){
       ...
       if(contErr!=0)
       {
           ...
           return RESULTADO.enumResultados.CamposVacios;
       }
       else
       {
           return RESULTADO.enumResultados.DatosValidados;
       }
    }
    
    public RESULTADO.enumResultados ModificarEmpleado(){
        
        Empleados E=new Empleados();
        
        if(E.ModificarEmpleado(varEmpleado)==RESULTADO.enumResultados.OperacionCorrecta)
        {
            //JOptionPane
           //(Frame, Mensaje, Titulo, Tipo)
           // Tipo(0) Error
           ...
           // Tipo(2) Advertencia
           // Tipo(3) Interragacion
           JOptionPane.showMessageDialog(null, "Los cambios se ha guardado correctamente.", "Notificacion" , 1);
           return RESULTADO.enumResultados.OperacionCorrecta;
        }
        
        return RESULTADO.enumResultados.ErrorDeSentencia;
    }
    ...
    private void initComponents() {
        ...
        btnGuardarCambios.setText("Completar registro");
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        if(ValidarDatos()==RESULTADO.enumResultados.DatosValidados){
            
            if(ModificarEmpleado()==RESULTADO.enumResultados.OperacionCorrecta)
            {
                CatalogoEmpleado.ListarEmpleados("");
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmMODEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmMODEmpleado(new JfrmCATEmpleado(), 1).setVisible(true);
            }
        });
    }
